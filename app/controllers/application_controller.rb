...
class ApplicationController < ActionController::Base
  ...
  def expire_general_caches
    %w(home_page_1 home_page_2 home_page_3 home_page_featured-0 home_page_featured-1 home_page_featured-2 front_large_banner_1 front_large_banner_2 front_large_banner_3 front_short_banner_1 front_short_banner_2).each do |frag|
